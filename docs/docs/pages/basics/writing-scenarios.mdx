...
Test how agents handle mistakes, you can enforce it to have made a mistake by using a <RefLink link={{ python: "script.html", typescript: "types/ScriptStep.html" }} code={{ python: "script", typescript: "ScriptStep" }} />,
