...
description: Generate and run your first adversarial test against your agent in under five minutes using the LangWatch /scenarios skill.
---
...
The skill teaches your coding assistant the Scenario API, the `RedTeamAgent` attack strategies, and the per-turn scoring loop. Once installed it shows up as a slash command in Claude Code, Cursor, Codex, and any other AgentSkills-compatible assistant:
...
```plaintext
/scenarios add red-teaming to my agent
```
